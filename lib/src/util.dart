...
extension HexColor on Color {
  ...
  String toHex({bool leadingHashSign = true}) {
    if (alpha != null && red != null && green != null && blue != null) {
      ...
      return '${leadingHashSign ? '#' : ''}$alphaHex$redHex$greenHex$blueHex';
    } else {
      // Handle the case where one or more components are null
      return '#000000'; // Default to black, adjust as needed
    }
  }
}

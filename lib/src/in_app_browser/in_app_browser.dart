...
class InAppBrowser {
  ...
  Future<void> openUrlRequest(
      {URLRequest urlRequest, InAppBrowserClassOptions options}) async {
    ...
    args.putIfAbsent(
        'options', () => options.toMap() ?? InAppBrowserClassOptions().toMap());
  ...
  Future<void> openFile(
      {String assetFilePath, InAppBrowserClassOptions options}) async {
